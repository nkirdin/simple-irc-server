...
import org.grass.simpleircserver.channel.ChannelModeCarrier;
import org.grass.simpleircserver.channel.IrcChannel;
import org.grass.simpleircserver.parser.IrcCommandReport;
import org.grass.simpleircserver.parser.IrcExecutionException;
...
public class IrcCommandBase implements IrcParamRegex {
     ...
     */    
    public static IrcCommandReport errNeedMoreParams(
     ...
     * @return объект с сообщением.
     */        
    public static IrcCommandReport errUnknownCommand(
            IrcTalker requestor, String commandName) {
     ...
     * @return объект с сообщением.
     */        
    public static IrcCommandReport errUModeUnknownFlag(
            IrcTalker requestor) {
     ...
     * @return объект с сообщением.
     */        
    public static IrcCommandReport errFileError(IrcTalker requestor,
