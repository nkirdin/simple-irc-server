 ...
 * клиенту в качестве успешного результата исполнения команды.
 *
...
public class ResponseSuccess extends Response {
     ...
     */
    public ResponseSuccess (Reply reply){
        super(reply);
    }
     ...
     */
    public static ResponseSuccess create(Response.Reply reply, 
            IrcTalker sender, String... args) {
        ResponseSuccess response = new ResponseSuccess(reply);
