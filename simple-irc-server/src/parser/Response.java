 ...
 * клиенту в качестве результата исполнения команды.
 *
...
public class Response {
    ...
    /** 
     * Переменная которая хранит результат исполнения команды в виде 
     * объекта Enum.
     */
    ...
    /** EnumSet с формализованными сообщениями */
    enum Reply {
        RPL_OK ( 0, "RPL_OK", "%s", "<prefix> <string>"),
        ...
        RPL_CHANNELMODEIS ( 324, "RPL_CHANNELMODEIS", "324 %s %s %s", "<channel> <mode mode params>"),
        ...
        private Reply(int code, String string, String format, String formatArgs) {
            this.code = code;
            this.string = string;
            this.format = format;
        }
    ...
    /**
     * Конструктор с параметром класса Reply.
     *@param reply формализованный результат выполнения команды.
     */
    ...
    /**
     * Задание формализованного результата выполнения команды.
     * @param reply формализованный результата выполнения команды.
     */
    ...
    /**
     * Получение формализованного результата выполнения команды.
     * @return reply формализованный результата выполнения команды.
     */
    ...
    /**
     * Задание текста сообщения для результата.
     */
     ...
     */
    public static String makeText(Response.Reply reply, String... args) {
        return String.format(reply.format, (Object[]) args);
    }

    /**
     * Получение текстового представления сообщения.
     * @return текстовое представление сообщения.
     */
    public String toString() {
        return text == null ?
               (reply != null ?
        (reply.string + " " + reply.code + " " + reply.format) : "") : text;
    }
}
