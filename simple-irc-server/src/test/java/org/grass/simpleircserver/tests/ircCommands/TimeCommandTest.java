 ...
 */
public class TimeCommandTest extends IrcCommandTest {
    ...
    public void timeCommandTest() {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("EEEEEEE MMMMMMM dd yyyy -- kk:mm ZZZZZ", Locale.ENGLISH);
        content = sdf.format(new Date());
        response = "391" + " " + userNickname[0] + " " + servername + " " + ":" + content;
        reply = icp.getRequestor().getOutputQueue().poll().getReport();
        
        assertTrue("RPL_TIME", reply.equals(":" + prefix + " " + response));
